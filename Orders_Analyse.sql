...
SELECT b.title , b.author , b.genre , b.published_year ,o.total_amount FROM Books b
JOIN Orders o 
...
SELECT COUNT(book_id) , genre FROM Books
GROUP BY genre;
...
SELECT c.name , SUM(o.total_amount) AS revenue FROM Customers c
JOIN Orders o
ON c.customer_id = o.customer_id
GROUP BY c.name
